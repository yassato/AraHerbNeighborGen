#################################
#export Zurich data for glmnetPy#
#################################
...
py_save_object(self, filename="../data/glmnetPyCHZselfMAF5.pkl", pickle="pickle")
py_save_object(nei, filename="../data/glmnetPyCHZneiS1MAF5.pkl", pickle="pickle")
py_save_object(pheno, filename="../data/glmnetPyCHZphenoMAF5map.pkl", pickle="pickle")
py_save_object(cov, filename="../data/glmnetPyCHZcovMAF5map.pkl", pickle="pickle")
