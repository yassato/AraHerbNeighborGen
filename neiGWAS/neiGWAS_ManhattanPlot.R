...
man2 = man2 + labs(title=substitute(paste(bold("b"))),subtitle="Individual no. of external chewers")
man3 = man3 + labs(title=substitute(paste(bold("c"))),subtitle="Individual no. of other herbivores")
...
hist2 = hist2 + labs(title=substitute(paste(bold("f"))),subtitle="Individual no. of external chewers")
hist3 = hist3 + labs(title=substitute(paste(bold("g"))),subtitle="Individual no. of other herbivores")
...
man2 = man2 + labs(title=substitute(paste(bold("j"))),subtitle="Individual no. of external chewers")
man3 = man3 + labs(title=substitute(paste(bold("k"))),subtitle="Individual no. of other herbivores")
...
hist2 = hist2 + labs(title=substitute(paste(bold("n"))),subtitle="Individual no. of external chewers")
hist3 = hist3 + labs(title=substitute(paste(bold("o"))),subtitle="Individual no. of other herbivores")
...
qq2 = qq2 + labs(title=substitute(paste(bold("f"))),subtitle="Individual no. of external chewers")
qq3 = qq3 + labs(title=substitute(paste(bold("g"))),subtitle="Individual no. of other herbivores")
...
man = (zman) | (jman)
ggsave(man,filename="../figs/GWASmain.jpg",width=19,height=9,dpi=600,bg="transparent")

znman = readRDS(file="../figs/CHZ_GWAS_s1_blank.rds")
jnman = readRDS(file="../figs/JPN_GWAS_s1_blank.rds")
nman = (znman) | (jnman)
ggsave(nman,filename="../figs/GWASmain_blank.pdf",width=19,height=9,bg="transparent")
...
ggsave(abc,filename="../figs/ZurichGWASall.jpg",width=16.5,height=8,dpi=300,bg="transparent")
...
abc = (a | b | c) + plot_layout(widths=c(2,0.75,2))
ggsave(abc,filename="../figs/JapanGWASall.jpg",width=16.5,height=8,dpi=300,bg="transparent")
